...
from ultralytics.yolo.utils import __version__, checks, emojis, is_colab, LOGGER, threaded
...
class HUBTrainingSession:
    ...
    def upload_model(self, epoch, weights, is_best=False, map=0.0, final=False):
        ...
        if final:
            ...
            smart_request(
                "post", url, data=data, files={"last.pt": file}, headers=self.auth_header, code=3
            )
