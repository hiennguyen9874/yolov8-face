...
class Exporter:
    ...
    def export_ncnn(self, prefix=colorstr("NCNN:")):
        ...
        if Path("./pnnx").is_file():
            ...
            asset = [
                x for x in assets if ("macos" if MACOS else "ubuntu" if LINUX else "windows") in x
            ][0]
    ...
    def export_saved_model(self, prefix=colorstr("TensorFlow SavedModel:")):
        ...
        for file in f.rglob("*.tflite"):
            f.unlink() if "quant_with_int16_act.tflite" in str(f) else self._add_tflite_metadata(
                file
            )
    ...
    def export_pb(self, keras_model, prefix=colorstr("TensorFlow GraphDef:")):
        ...
        import tensorflow as tf  # noqa
        from tensorflow.python.framework.convert_to_constants import (  # noqa
