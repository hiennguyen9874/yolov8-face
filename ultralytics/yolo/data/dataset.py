...
from ..utils import is_dir_writeable, LOCAL_RANK, NUM_THREADS, TQDM_BAR_FORMAT
from .augment import (
...
from .utils import get_hash, HELP_URL, img2label_paths, LOGGER, verify_image_label
...
class YOLODataset(BaseDataset):
    ...
    def get_labels(self):
        ...
        if exists and LOCAL_RANK in (-1, 0):
            ...
            tqdm(
                None, desc=self.prefix + d, total=n, initial=n, bar_format=TQDM_BAR_FORMAT
