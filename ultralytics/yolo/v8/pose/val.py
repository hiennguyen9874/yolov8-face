...
from ultralytics.yolo.utils.metrics import box_iou, kpt_iou, OKS_SIGMA, PoseMetrics
...
class PoseValidator(DetectionValidator):
    ...
    def update_metrics(self, preds, batch):
        ...
        for si, pred in enumerate(preds):
            ...
            ops.scale_coords(
                batch["img"][si].shape[1:], pred_kpts, shape, ratio_pad=batch["ratio_pad"][si]
            )
            ...
            if nl:
                ...
                tkpts = ops.scale_coords(
                    batch["img"][si].shape[1:], tkpts, shape, ratio_pad=batch["ratio_pad"][si]
                )
