...
from ultralytics.yolo.utils import colorstr, DEFAULT_CFG, LOGGER, ops
from ultralytics.yolo.utils.checks import check_requirements
from ultralytics.yolo.utils.metrics import box_iou, ConfusionMatrix, DetMetrics
...
class DetectionValidator(BaseValidator):
    ...
    def init_metrics(self, model):
        ...
        self.is_coco = (
            isinstance(val, str) and "coco" in val and val.endswith(f"{os.sep}val2017.txt")
        )  # is COCO
